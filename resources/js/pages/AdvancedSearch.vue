<template>
    ...
    <div class="input-group">
      ...
      <select v-model="minAvgRating" class="form-select" name="min-avg-rating" aria-label="Selezione voto medio minimo">
      ...
      <select v-model="minReviewCount" class="form-select" name="min-avg-rating" aria-label="Selezione numero minimo recensioni">
