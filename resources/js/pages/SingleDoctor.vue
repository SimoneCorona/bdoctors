<template>
  <div class="mt-5">
    ...
    <div class="row">
      ...
      <div class="col-auto">
        <img
          class="doctor-image rounded-circle mb-5 w-100"
      ...
      <div class="col-12 col-lg-auto">
        ...
        <p>
          <i
            class="fas fa-star"
            :class="n <= starsInReviews ? 'text-warning' : 'text-muted'"
            v-for="n in 5"
            :key="n"
          ></i>
        </p>
    ...
    <div class="container">
      <div class="row">
        <div class="col-6">
          ...
          <p class="me-5 mb-5" style="max-height: 40vh; overflow-y: auto">
    ...
    <div class="container">
      ...
      <div class="col-sm-12 col-md-12 col-lg-6">
        ...
        <div class="my-3 flex-nowrap">
          ...
          />
          <div v-show="errors.message.includes('author')" class="text-danger">
            Inserisci il nome
          </div>
        </div>
        <div class="mb-3 flex-nowrap">
          <input
            ...
            aria-describedby="addon-wrapping"
          />
          <div v-show="errors.message.includes('email')" class="text-danger">
        ...
        <div class="d-flex align-items-center justify-content-end">
          <span v-show="message_sent" class="text-success me-2"
            >Messaggio inviato! &#10004;</span
          >
          <button class="btn btn-primary text-light" @click="postMessage()">
      ...
      <div class="col-sm-12 col-md-12 col-lg-6">
        ...
        <div v-show="errors.review.includes('rating')" class="text-danger">
        ...
        <div class="my-3 flex-nowrap">
          <input
            ...
            aria-describedby="addon-wrapping"
          />
          <div v-show="errors.review.includes('author')" class="text-danger">
            Inserisci il nome
          </div>
        </div>
        <div class="form-floating mb-3">
        ...
        <div class="d-flex align-items-center justify-content-end">
          <span v-show="review_sent" class="text-success me-2"
